...
public class CancelDialogAdapter extends BaseAdapter {
    Context appCompatActivity;
    int count;

    public CancelDialogAdapter() {
    }

    public CancelDialogAdapter(Context appCompatActivity, int count) {
        try{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {// inflate the layout for each list row
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(appCompatActivity).
                    inflate(R.layout.row_cancel_dialog, parent, false);
